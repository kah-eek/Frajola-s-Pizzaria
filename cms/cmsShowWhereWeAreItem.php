<?php
    ...
    if (isset($_GET["active"])) {
        ...
        if ($active == "true") {
            setStatus($_GET["id"], 1);
            header("location:cmsShowWhereWeAreItem.php");
    ...
    if(isset($_GET["mode"])){
        ...
        if ($mode == "delete") {
            ...
            }else{// SHOW ALERT BECAUSE ITEM DOESN'T WAS DELETED
            ?>
...
<html lang="pt">
    <head>
        ...
        <meta charset="utf-8">
        <link rel="stylesheet" type="text/css" href="css/cmsShowWhereWeAreItem.css">
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="showDecadeItemsBox">
                ...
                ?>
                    <div class="decadeItemBox">
                        <div class="itemImage">
                            <img src="<?php echo(cutPathNoEnd($rs["imagemEstabelecimento"], 3));?>" title="Foto do estabelecimento" alt="Foto do estabelecimento">
                        ...
                        <div class="editDeleteBox">
                            <a href="?id=<?php echo($rs["idItemPagina"]);?>&mode=delete">
                                <img src="../pictures/icons/delete-icon512.png" onclick="return confirm('Deseja realmente excluir ?')" title="Deletar" alt="Deletar este item">
                            </a>
                            
                            <a href="cmsAddWhereWeAreItem.php?id=<?php echo($rs["idItemPagina"]);?>&mode=update">
            ...
            <div class="addItemButtonBox">
                <a href="cmsAddWhereWeAreItem.php?mode=add&status=false&checkedStatus=true&id=-1">
