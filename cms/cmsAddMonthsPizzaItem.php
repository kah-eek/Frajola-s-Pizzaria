...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <link rel="stylesheet" type="text/css" href="css/cmsAddMonthsPizzaItem.css">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("#frmAddDecadeItem").submit(function(event){
                    ...
                    $.ajax({
                        type:"POST",
                        url:"./controller/cmsAddMonthsPizzaItemController.php?mode="+mode+"&status="+status+"&id="+id+"",
                ...
                <div id="showItemsBox">
                    ...
                    <div id="mainBox">
                        ...
                        <div class="labelAndTextFieldBox">
                            ...
                            <div class="textField">
                                <input type="text" maxlength="100" name="txtTitle" value="<?php echo($item["titulo"]);?>" required>
                            </div>
                        </div>
                        ...
                        <div id="textAreaBox">
                            ...
                            <textarea required maxlength="210" name="txtDescription" rows="8" cols="74"><?php echo($item["descricao"]);?></textarea>
                        </div>
