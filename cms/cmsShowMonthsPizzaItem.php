<?php
    ...
    if (isset($_GET["active"])) {
        ...
        if ($active == "true") {
            setStatus($_GET["id"], 1);
            header("location:cmsShowMonthsPizzaItem.php");
...
<html lang="pt">
    <head>
        ...
        <meta charset="utf-8">
        <link rel="stylesheet" type="text/css" href="css/cmsShowMonthsPizzaItem.css">
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="showDecadeItemsBox">
                ...
                ?>
                    <div class="decadeItemBox">
                        <div class="itemImage">
                            <img src="<?php echo(cutPathNoEnd($rs["imagem"], 3));?>" title="<?php echo($rs["titulo"])?>" alt="Imagem do item a ser gerenciado (<?php echo($rs["titulo"])?>)">
                        ...
                        <div class="editDeleteBox">
                            ...
                            <a href="cmsAddMonthsPizzaItem.php?id=<?php echo($rs["idItemPagina"]);?>&mode=update">
            ...
            <div class="addItemButtonBox">
                <a href="cmsAddMonthsPizzaItem.php?mode=add&status=false&checkedStatus=true&id=-1">
