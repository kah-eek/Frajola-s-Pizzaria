...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <link rel="stylesheet" type="text/css" href="css/cmsAddPromotionItem.css">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("#frmAddDecadeItem").submit(function(event){
                    ...
                    $.ajax({
                        type:"POST",
                        url:"./controller/cmsAddPromotionItemController.php?mode="+mode+"&status="+status+"&id="+id+"",
                ...
                <div id="showItemsBox">
                    ...
                    <div id="mainBox">
                        ...
                        <div id="textAreaBox">
                            ...
                            <textarea required maxlength="210" name="txtDescription" rows="8" cols="74"><?php echo(strip_tags($item["descricao"]));?></textarea>
                        </div>

                        <!-- NO PROMOTION -->
                        <div class="labelAndTextFieldBox">
                            <div class="label">
                                PREÇO NÃO PROMOCIONAL
                            </div>
                            <div class="textField">
                                <input type="text" maxlength="5" onkeypress="return blockType(event,'characterAllowDot')" name="txtNoPromotion" value="<?php echo($item["precoNaoPromocional"]);?>" required>
                            </div>
                        </div>
                        ...
                        <div class="labelAndTextFieldBox">
                            ...
                            <div class="textField">
                                <input type="text" maxlength="5" onkeypress="return blockType(event,'characterAllowDot')" name="txtWithPromotion" value="<?php echo($item["precoPromocional"]);?>" required>
                            </div>
                        </div>
                        ...
                        <div class="labelAndTextFieldBox">
                            ...
                            <div class="textField">
                                <input type="text" maxlength="10" onkeypress="return blockType(event,'noDate')" placeholder="__/__/____" name="txtExpiryDate" value="<?php echo(setDateFormat('user',$item["dtValidade"]));?>" required>
                            </div>
                        </div>
