...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <link rel="stylesheet" type="text/css" href="css/cmsAddDecadeItem.css">
            ...
            $(document).ready(function() {
                ...
                $(".statusLink").click(function() {
                    ...
                    if(status =='Desativado'){
                        ...
                        // $("#statusImage").css({'backgroundImage': "url('../pictures/icons/greenCheck48x48.png')",'backgroundRepeat':'no-repeat','width':'48px', 'height':'48px'});
                        ...
                        // $("#statusImage").css({'backgroundImage':  "url('../pictures/icons/grayCheck48x48.png')",'backgroundRepeat':'no-repeat','width':'48px', 'height':'48px'});
                ...
                $("#frmAddDecadeItem").submit(function(event){
                    ...
                    $.ajax({
                        type:"POST",
                        url:"./controller/cmsAddDecadeItemController.php?mode="+mode+"&status="+status+"&id="+id+"",
...
//                             alert("Dados enviados\n\n./controller/cmsAddDecadeItemController.php?mode="+mode+"&status="+status+"&id="+id+"");
    ...
    <body>
        ...
        <!-- MAIN CONTENT -->
        <form name="frmAddDecadeItem" id="frmAddDecadeItem" method="POST" action="cmsAddDecadeItem.php?mode=<?php echo($_GET['mode']);?>&id=<?php echo($_GET['id']); ?>" enctype="multipart/form-data">
            <div id="main">
                ...
                <div id="showItemsBox">
                    ...
                    <div id="mainBox">
                        ...
                        <div class="labelAndTextFieldBox">
                            ...
                            <div class="textField">
                                <input type="text" maxlength="100" name="txtTitle" value="<?php echo(strip_tags($item["titulo"], '<prev>'));?>" required>
                            </div>
                        </div>
                        ...
                        <div class="labelAndTextFieldBox">
                            ...
                            <div class="textField">
                                <select required name="cbxDecade">
                                    ...
                                    for($i = 0; $i < mysql_num_rows($size); $i++){
                                        ...
                                        if ($rs["idDecada"] == $item["idDecada"]) {
                                        ?>

                                            <option selected value="<?php echo($rs["idDecada"]);?>"><?php echo($rs["decada"]);?></option>

                                        <?php
                                        }else{
                                        ?>

                                            <option value="<?php echo($rs["idDecada"]);?>"><?php echo($rs["decada"]);?></option>
                        ...
                        <div class="labelAndTextFieldBox">
                            ...
                            <div class="textField">
                                ...
                                if (isset($_GET["mode"])) {
                                    ...
                                    ?>
                                    <input type="file" name="bgImage" required>
                                    <?php
                                    }
                                }
                                ?>
                        ...
                        <div id="textAreaBox">
                            ...
                            <textarea required maxlength="500" name="txtDescription" rows="8" cols="74"><?php echo(strip_tags($item["descricao"]));?></textarea>
                        </div>
