<?php
    ...
    if (isset($_GET["active"])) {
        ...
        if ($active == "true") {
            setStatus($_GET["id"], 1);
            header("location:cmsShowAboutUsItem.php");
    ...
    <body>
        ...
        <div id="main">
                ...
                ?>
                    <div class="decadeItemBox">
                        ...
                        <div class="editDeleteBox">
                            ...
                            <a href="cmsAddAboutUsItem.php?id=<?php echo($rs["idItemPagina"]);?>&mode=update">
            ...
            <div class="addItemButtonBox">
                <a href="cmsAddAboutUsItem.php?mode=add&status=false&checkedStatus=true&id=-1">
